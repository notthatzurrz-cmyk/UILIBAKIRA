-- UilibAKiralite / Library.lua
-- AkiraLite UI Library
local function InitLibrary()
        ...
        -- Reliable high-contrast modern typography
        do
        ...
        function w:CreateGUI()
            ...
            -- ========================================================
            -- FLOATING PILL DOCK BAR (matching requested mockup)
            -- ========================================================
            local Dock = Instance.new("Frame")
            Dock.Name = "DockBar"
            Dock.AnchorPoint = Vector2.new(0.5, 1)
            Dock.Position = UDim2.new(0.5, 0, 0.94, 0)
            Dock.Size = UDim2.fromOffset(136, 44)
            ...
            FeaturesIcon.Image = "rbxassetid://10709791437" -- Layout grid icon
            ...
            -- Settings Tab Button (Configs, Autoloading, Themes)
            local SettingsBtn = Instance.new("TextButton")
            SettingsBtn.Name = "SettingsBtn"
            SettingsBtn.Text = ""
            SettingsBtn.Size = UDim2.fromOffset(40, 36)
            SettingsBtn.Position = UDim2.new(0.7, 0, 0.44, 0)
            ...
            SettingsIcon.Image = "rbxassetid://10734950309" -- Sliders icon
            ...
            -- Active Glow Dot Indicator (underneath active icon, matching image)
            ...
            -- ========================================================
            -- ========================================================
            -- DEDICATED HIGH-CONTRAST SETTINGS & CONFIGS WINDOW
            -- ========================================================
            ...
            -- Helper for sleek neutral monochrome button interactions
            ...
            -- 1. Card Header (Strictly at top: LayoutOrder = 1)
            ...
            -- 2. Autoload Info Row (NO EMOJIS, NO YELLOW)
            ...
            -- 4. Scrollable Config List (STRICTLY NO EMOJIS, High Contrast)
            ...
            -- 5. Button Row 1 (Load / Save) - NO COLOR, Sleek Neutral Monochrome
            ...
            -- 6. Button Row 2 (Overwrite / Delete) - NO RED, Sleek Neutral Monochrome
            ...
            -- 6. Unload & Uninject Button (NO RED, Neutral Monochrome with Crisp White Text)
            ...
            local function SwitchTab(tabName)
                w.ActiveTab = tabName
                local isFeatures = (tabName == "Features")
                d:Create(ActiveDot, TweenInfo.new(0.25, Enum.EasingStyle.Quart), {
                    Position = isFeatures and UDim2.new(0.3, 0, 1, -7) or UDim2.new(0.7, 0, 1, -7)
                }):Play()
                d:Create(FeaturesIcon, TweenInfo.new(0.2, Enum.EasingStyle.Linear), {
                    ImageColor3 = isFeatures and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(130, 130, 140)
                }):Play()
                d:Create(SettingsIcon, TweenInfo.new(0.2, Enum.EasingStyle.Linear), {
                    ImageColor3 = not isFeatures and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(130, 130, 140)
                }):Play()
                if w.ClickGuiStatus then
                    if isFeatures then
                        SettingsWin.Visible = false
                        V.Visible = true
                        d:Create(SetWinScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential), {Scale = 0}):Play()
                        d:Create(V.UIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential), {Scale = w.Scale.Value}):Play()
                    else
                        V.Visible = false
                        SettingsWin.Visible = true
                        d:Create(V.UIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential), {Scale = 0}):Play()
                        d:Create(SetWinScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential), {Scale = w.Scale.Value}):Play()
                    end
                end
            end
            ...
            self.AddCatalog = function(m, m)
                ...
                i.AddModule = function(R, R)
                    ...
                    q.AddDropdown = function(x, x)
                        ...
                        SelectBtn.Size = UDim2.new(0.48, 0, 0.8, 0)
...
-- Interface module moved exclusively to Settings Window
        T(function()
            L = A:AddModule({
                Name = "Target Hud",
                Function = function(B)
        ...
        shared.AkiraLite = w
        -- Automatic Autoload on execution
        task.spawn(function()
            task.wait(0.2)
            pcall(function()
                w:Autoload()
...
-- Return a callable table/function so both Library() and Library.Init() work seamlessly
